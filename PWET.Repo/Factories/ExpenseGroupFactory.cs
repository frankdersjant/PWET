...
{
    public static class ExpenseGroupFactory
    {
        ...
        public static object CreateDataShapedObjectExpenseGroup(ExpenseGroup expenseGroup, List<string> lstOfFields)
        {
            return CreateDataShapedObjectExpenseGroup(CreateExpenseGroupDTO(expenseGroup), lstOfFields);
        }
